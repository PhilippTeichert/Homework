...
Bereits nach kurzer Zusammenarbeit ergab sich, wie vorteilhaft diese Meetings für die Kooperation waren, weswegen die Anzahl der Treffen auf bis zu vier pro Tag anstieg.
Das \textit{Kanban-Board} ist eine Tafel, an die die aktuellen Aufgaben angeschrieben werden.
Dies hilft, die Aufgaben aufzuteilen und nicht den Überblick zu verlieren. Zudem ist es ein Ort für dringende Aufgaben oder Probleme, damit das Team, welches als nächstes mit seiner Aufgabe fertig wird, sofort eine neue findet.
...
Ebenso können sie aufgehoben werden, wenn sich der Spieler direkt davor stellt und die Enter-Taste drückt.\\%Aktionstaste
