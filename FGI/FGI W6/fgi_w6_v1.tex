...
\begin{document}
	...
	\section*{Aufgabe 5.4}
	\label{sec:a5.4}
	Es handelt sich um einen DTM mit einem rechtsunendlichen Band.\\
	\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3.5cm,semithick]
	    ...
	    \path
	        ...
	        (G) edge [loop above]	 node [align=left] {a,a,L \\ b,b,L \\ \#,\#,L}	(G)
	...
	Anschließend gehen wir zu dem $S$ zurück und suchen uns das nächste Zeichen $\neq$ \textit{\#}.
	...
	Man markiert den ersten Buchstaben, schreibt an das Ende des Wortes ein $X$ und geht zurück an den Anfang.\\
	\textbf{\textit{G}:} Dort ersetzt man jetzt das $A$ (analog $B$), welches sich dort befindet, durch ein $S$ und löscht das nächste $b$ (analog $a$).
	...
	\\
	$L_1 \underline{\subset} L(G)~(G~erzeugt~jedes~Wort~aus~L_1)$\\
