...
\begin{document}
	...
	\begin{equation*}
		\begin{array}{ll}
			...
			( C \lor A ) \land 8 C \lor \lnot B )								& \text{\textbf{\underline{HULK FINISH!!}}}
		\end{array}
	\end{equation*}
	\subsection*{9.5.2}
	\label{ssec:9.5.2}
	...
	\begin{equation*}
		\begin{array}{ll}
			( ( A \Leftrightarrow B ) \lor \lnot B ) \land \lnot C												& \text{Eliminieren von } \Leftrightarrow \\
			( ( \lnot A \lor B ) \land ( \lnot B \lor A ) ) \lor \lnot B ) \lnot C								& \text{Anwenden des Distributivgesetzes} \\
			( ( ( \lnot A \lor B ) \lor \lnot B ) \land ( ( \lnot B \lor A ) \lor \lnot B ) ) \land \lnot C		& \text{Anwenden des Assoziativgesetzes} \\
			( \lnot A \lor B \lor \lnot B ) \land ( \lnot B \lor A \lor \lnot B ) \land \lnot C					& \text{Kürzen von } \lnot B \\
			( \lnot A \lor B \lor \lnot B ) \land ( \lnot B \lor A ) \land \lnot C								& (\lnot B \lor B)=1 \Rightarrow~A\text{ kann im ersten Term} \\
																												& \text{omittiert werden, da der Term immer als 1} \\
																												& \text{ausgewertet wird} \\
			( B \lor \lnot B ) \land ( A \lor \lnot B ) \land \lnot C											& \text{Anwenden des Distributivgesetzes} \\
			\lnot B \lor ( ( A \land B ) \land \lnot C )														& \text{Anwenden des Assoziativgesetzes} \\
			\lnot B \lor ( A \land B \land \lnot C )															& \text{\textbf{\underline{HULK FINISH!!}}}
		\end{array}
	\end{equation*}
	%++++++++++++++++++++++++++++++++++++++++++++++++++++++++++%
	\section*{Aufgabe 9.6}
