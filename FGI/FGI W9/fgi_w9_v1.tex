...
\begin{document}
	...
	\\
	$G \vDash H$ bedeutet: Wenn \textit{G} wahr ist und \textit{H} wahr ist, gilt dies; wenn \textit{G} wahr ist, \textit{H} jedoch falsch ist, gilt dies nicht; wenn \textit{H} wahr ist, gilt dies $\Rightarrow A$ und \textit{B} sind identisch.\\
	\\
