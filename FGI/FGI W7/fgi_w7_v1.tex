...
\begin{document}
	...
	\\
	%-----LÖSUNG-----%
	Frau Muß bitte an den Kartoffelpuffer.
	Ja also wir wählen zuerst für jeden Knoten. Zuerst bildet man einen Knoten nichtdeterministisch aus G1 auf G2 nein nein nein es soll ein Knoten aus G2 sein. r
	...
	Zeigen Sie ferner, dass ein Algorithmus mit exponentieller Laufzeit entstehen kann,
	wenn ein Algorithmus eine polynomiale Anzahl von Aufrufen von Unterroutinen mit polynomialer Laufzeit enthält.\\
	\\
	\\
	%-----LÖSUNG-----%
\end{document}