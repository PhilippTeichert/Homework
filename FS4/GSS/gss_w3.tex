...
\grafik{
	\begin{blockgraph}{17}{4}{1}
		...
		\bgblock[0]{7}{9}{Z}
		\bgblock[0]{9}{10}{B}
		\bgblock[0]{11.5}{14.5}{M}
		\bgblock[0]{14.5}{15.5}{B}
		\bgblock[0]{15.5}{17}{Z}
		
		\bgblock[1]{0}{1}{lock(B)}
		\bgblock[1]{3}{6}{lock(M)}
		\bgblock[1]{6}{7}{lock(B)}
		\bgblock[1]{9}{10}{lock(B)}
		\bgblock[1]{11.5}{14.5}{lock(M)}
		\bgblock[1]{14.5}{15.5}{lock(B)}
