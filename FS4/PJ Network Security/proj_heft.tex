...
Bei Verwendung des Befehls \command{cat /dec/urandom} als \texttt{labmate} erscheint im \texttt{top}-Fenster ein neuer Prozess, der \texttt{labmate} zugeordnet ist und eine Menge Speicher futtert.
