...
\susP{5.1}{11}
	...
	\]
	\[
		P(X \leq 2) = \mysum{0}{2} \frac{\binom{70}{i} \binom{1000-70}{8-i}}{\binom{1000}{8}}\approx 0.8972 \hat{=} 89.72\%
	\]
	...
	\[
		P(X\leq 2) = \mysum{0}{2}\binom{1000}{8}\cdot\left(\frac{70}{1000}\right)^k\cdot\left(1-\frac{70}{1000}\right)^{1000-k} \approx 7.9257x10^{13}
	\]
	Abweichung vehement; Binomialverteilung eignet sich als Näherung erst, wenn die Standardabweichung ($\sigma$) größer als 3 beziehungsweise die Varianz ($V(x)$) größer als 9 ist (hier ist $\sigma \approx 2.1$).
\susP{5.2}{10}
	...
	\]
	\begin{equation}
		P(X=\leq 1)=\mysum{0}{1}\binom{52}{i} \cdot 0.01^k \cdot 0.99^{52-i} \approx 0.9044 \hat{=} 90.44\%
	\end{equation}
	\begin{equation}
...
\sect{6}{26. Mai 2016}{3. Mai 2016}
\fi
\ifnum\ZettelSieben=\True
\sect{7}{26. Mai 2016}{3. Mai 2016}
\fi
\ifnum\ZettelAcht=\True
\sect{8}{26. Mai 2016}{3. Mai 2016}
\fi
\ifnum\ZettelNeun=\True
\sect{9}{26. Mai 2016}{3. Mai 2016}
\fi
\ifnum\ZettelZehn=\True
\sect{10}{26. Mai 2016}{3. Mai 2016}
\fi
\ifnum\ZettelElf=\True
\sect{11}{26. Mai 2016}{3. Mai 2016}
\fi
\ifnum\ZettelZwoelf=\True
\sect{12}{26. Mai 2016}{3. Mai 2016}
\fi
