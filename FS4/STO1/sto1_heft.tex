...
\begin{enumerate}
	...
	\vspace{.5cm}\\
	%%%%% Bearbeitung 1a ----------
	\textbf{Kein Zufall}, da 1. spezifische physikalische Umstände die Aktivität bedingen und 2. die Situation nicht rekonstruiert werden kann.
	
	%%%%% Aufgabe 1b ---------------
	\item[b)] Verkehrssituation am Schlump Donnerstags 10:00.\\
	\vspace{.5cm}\\
	%%%%% Bearbeitung 1b ----------
	\textbf{Zufall}, da die Situation rekonstruiert und dementsprechend das Experiment beliebig oft wiederholt werden kann.
	...
	\vspace{.5cm}\\
	%%%%% Bearbeitung 1d ----------
	\textbf{Kein Zufall}, da die Umstände für jeden Kaiser eindeutig sind und dementsprechend die Situation nicht vollständig wiederhergestellt wird.
