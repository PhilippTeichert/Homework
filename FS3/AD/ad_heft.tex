...
\end{minipage}\\
\begin{tikzpicture}
\node	[circle,draw,dotted]	(root)	{\texttt{nil}}
	child{
		node	[circle,draw]	(5)	{5}		
		child{
			node	[circle,draw,dotted]	(leaf1)	{\texttt{nil}}
		}
		child{
			node	[circle,draw]	(8)	{8}
			child{
				node	[circle,draw]	(6)	{6}
					child{
						node	[circle,draw,dotted]	(leaf4)	{\texttt{nil}}
					}
					child{
						node	[circle,draw]	(7)		{7}
							child{
								node	[circle,draw,dotted]	(leaf5)	{\texttt{nil}}
							}
							child{
								node	[circle,draw,dotted]	(leaf6)	{\texttt{nil}}
							}
					}
			}
			child{
				node	[circle,draw]	(9)	{9}
					child{
						node	[circle,draw,dotted]	(leaf2)	{\texttt{nil}}
					}
					child{
						node	[circle,draw,dotted]	(leaf3)	{\texttt{nil}}
					}
			}
		}
	};
