...
Dies hat eine maximale Laufzeit von $\Sigma_{i=1}^n \binom{8}{k_i} \approx \binom{8}{k}^n$ , wenn für jeden Knoten alle Kombinationen durchlaufen werden müssen, wobei $\binom{8}{k}$ konstant und höchstens $70 = \binom{8}{4}$ ist.\\
