...
\begin{enumerate}
	...
	T_3(n) := \begin{cases}
   	...
   	\begin{enumerate}
   	    ...
   	    Da aber nur $d_3\cdot n\cdot log(n) \leq n^{log_3(6)}$ für alle $n \in \mathbb{N}$ \footnote{s. Aufgabenstellung} $\wedge n > 1$ \footnote{s. Definition $T_3$} gefordert ist, kann hierfür mindestens ein $\epsilon$ gefunden werden.\\
   	    Die muss nun für alle $d_3$ ausprobiert werden.
   	\end{enumerate}
\end{enumerate}
