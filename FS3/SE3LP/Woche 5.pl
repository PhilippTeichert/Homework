...
% Anmerkung: 'Integer' hat eigentlich ein ?, wenn man allerdings eine Variable anstelle einer konkreten Zahl eingibt, rechnet das Programm, nachdem es die erste Lösung gefunden hat, unendlich weiter.
